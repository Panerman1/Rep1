...
input_prompt =   """Under the title "LOCATION AND BASIC INFO :-"(in bold italic) , You have to identify the name of the location (if it is a popular location), name of the structure (if it has a name),  state and country of the place in the image that is provided. Also describe few key features about the location in the image.After this, display the title "ANSWER TO ADDITIONAL QUESTIONS ( If Any) :-"(in bold italic) """
